...
-  location of PredicTF (e.g. /home/user/PredicTf)  
-  location of the target genome for predicting TFs (in aminoacid format)  
-  folder to store results (e.g. /home/project/results)  
...
-  project folder location (e.g. /home/user/project)  
-  the fasta file with the TFs (used to create the similarity matrix)  
-  location where the conda environment was generated (e.g /home/user)  
-  location of PredicTF installation folder (e.g. /home/user/PredicTF)  
...
-  location of PredicTF (e.g. /home/user/PredicTf)  
-  location of the target genome for predicting TFs (in aminoacid format)  
-  folder to store results (e.g. /home/test_genome/results)  
-  path to the project folder where the new model is stored (e.g. /home/project)  
